...
export const SingleVehicle = () => {
  ...
  const cloudinaryBaseURL =
    "https://res.cloudinary.com/dbqfhbhzu/image/upload/v1740346391/";
  const vehicle = store.vehicles;
  return (
    <div className="text-center mt-5">
      <h1 style={{ color: "#112d4e", fontWeight: "bold" }}>{marca} {modelo}</h1>
            ...
            <div className="card text-center p-3 w-100">
              <Carousel className="mb-3">
                <Carousel.Item>
                  <img
                    className="d-block w-100"
                    src={`${cloudinaryBaseURL}${id}-1.jpg`}
                    alt="Placeholder 1"
                  />
                </Carousel.Item>
                <Carousel.Item>
                  <img
                    className="d-block w-100"
                    src={`${cloudinaryBaseURL}${id}-2.jpg`}
                    alt="Placeholder 2"
                  />
                </Carousel.Item>
                <Carousel.Item>
                  <img
                    className="d-block w-100"
                    src={`${cloudinaryBaseURL}${id}-3.jpg`}
                    alt="Placeholder 3"
                  />
                </Carousel.Item>
              </Carousel>
